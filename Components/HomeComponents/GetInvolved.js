...
const GetInvolved = () => {
  return (
    <div className="relative w-full h-[50vh] bg-[url(/images/get-involved-bg.png)] bg-no-repeat bg-cover bg-center">
      {/* Overlay */}
      <div className="absolute inset-0"></div>

      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold md:-mt-24 ">
          Get Involved
        </h1>
        <p className="mt-4 md:mt-10 max-w-2xl text-sm md:text-lg font-light text-white/70">
        ...
        <p className="mt-4 max-w-2xl text-sm md:text-lg font-light text-white/70">
        ...
        <p className="mt-4 text-sm md:text-lg font-light text-white/70">
        ...
        {/* Contact Person */}
        <p className="my-4 text-sm md:text-lg font-light text-white/70">
